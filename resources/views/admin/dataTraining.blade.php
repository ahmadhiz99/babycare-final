...
<div>
  ...
  <div data-toggle="modal" data-target="#dataTrainingModal" class="btn btn-primary">Add Data Training</div>
    ...
    <div class="row text-center p-2">
      ...
      <!-- {{ $dataTraining->links()}} -->
      {{ $dataTraining->links('pagination::bootstrap-4')}}
      </div>
    </div>
</div>
        ...
        @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input name="length" type="number" step="0.01" class="form-control" id="exampleInputEmail1" placeholder="Masukan Panjang Bayi" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Berat (kg)</label>
                    <input name="weight" type="number" step="0.01" class="form-control" id="exampleInputEmail1" placeholder="Masukan Berat Bayi" required>
                  </div>
                  <div class="form-group">
